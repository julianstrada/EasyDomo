...
if($module->id=='0')				//new_module
{
	...
	$stmt = $module->update_module_data_fromindex($module->id, $module->user, $module->module_name, $module->description, $module->hr_encendido, $module->min_encendido, $module->hr_apagado,$module->min_apagado);
